...
void menuPagos()
{
	...
	const char* titulo = "Menu Pagos";
	const char* opciones[] = { "Formularios", "Tarjeta de debito o credito", "Salir" };
	int n = 3;
...
void menuGestiones()
{
	...
	const char* titulo = "Menu Gestiones";
	const char* opciones[] = { "Cerfiticaciones", "Cambio de carrera", "Equiparaciones Automaticas", "Salir" };
	int n = 4;
...
void menuPensum()
{
	...
	gotoxy(53, 2); cout << "Ingrese Carrera" << endl;
	cin >> carrera;
	system("pause");
}
void menuHorarios()
